...
handoffs:
  - label: Diagnose Test Failures
    agent: BDD Healer
    prompt: Diagnose and fix the test failures encountered after implementing the step definitions above.
    send: false
---
...
When tests fail after implementing step definitions, use the **Diagnose Test Failures** handoff button to transition to the bdd-healer agent for systematic diagnosis and repair.
